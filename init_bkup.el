...
;; setup ivy: Generic completion frontend that's just awesome! Let's install and enable it.
 (use-package ivy
   :demand t)
...
;;nov mode - EPUB Reader for Emacs n
(use-package nov 
  :demand t)
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (define-word ereader nova-theme nov nov-mode projectile ivy org spacemacs-theme yasnippet-snippets xclip use-package toc-org slack org-sidebar org-plus-contrib magit lsp-ui lsp-java idle-highlight flycheck dap-mode counsel-projectile company-lsp ample-theme))))
(custom-set-faces
